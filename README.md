...
Rooms use activity-based expiration: waiting lobbies expire after 30 minutes of inactivity, active games after 24 hours, and finished games after 60 minutes. These values can be changed with `LOBBY_IDLE_MINUTES`, `ACTIVE_GAME_IDLE_HOURS`, and `FINISHED_GAME_RETENTION_MINUTES`.
